...
func (r *RecipeDeploymentResourceModel) ToCreateSDKType() *shared.CreateRecipeDeployment {
	...
	var networking *shared.CreateRecipeNetworking
	if r.Networking != nil {
		auth := r.Networking.Auth.ValueBool()
		port := r.Networking.Port.ValueInt64()
		protocol := shared.RecipeNetworkingProtocol(r.Networking.Protocol.ValueString())
		networking = &shared.CreateRecipeNetworking{
			Auth:     auth,
			Port:     port,
			Protocol: protocol,
		}
	}
	recipeName := r.RecipeName.ValueString()
	replicas := r.Replicas.ValueInt64()
	out := shared.CreateRecipeDeployment{
...
func (r *RecipeDeploymentResourceModel) ToGetSDKType() *shared.CreateRecipeDeployment {
	out := r.ToCreateSDKType()
	return out
}

func (r *RecipeDeploymentResourceModel) ToUpdateSDKType() *shared.UpdateRecipeDeployment {
	displayName := new(string)
	if !r.DisplayName.IsUnknown() && !r.DisplayName.IsNull() {
		*displayName = r.DisplayName.ValueString()
	} else {
	...
	out := shared.UpdateRecipeDeployment{
		DisplayName: displayName,
		Replicas:    replicas,
	}
	return &out
...
func (r *RecipeDeploymentResourceModel) ToDeleteSDKType() *shared.CreateRecipeDeployment {
	out := r.ToCreateSDKType()
	return out
}

func (r *RecipeDeploymentResourceModel) RefreshFromGetResponse(resp *shared.RecipeDeployment) {
...
func (r *RecipeDeploymentResourceModel) RefreshFromCreateResponse(resp *shared.RecipeDeployment) {
	r.RefreshFromGetResponse(resp)
}

func (r *RecipeDeploymentResourceModel) RefreshFromUpdateResponse(resp *shared.RecipeDeployment) {
	r.RefreshFromGetResponse(resp)
}
